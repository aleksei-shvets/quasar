export default {
  ...
  sign: {
    ...
    t3: 'Осталось только ввести и запомнить надёжный пароль',
    ...
    mnemonic: 'Твоя мнемоническая фраза',
    publicKey: 'Твой публичный адрес'
  },
  enter: {
